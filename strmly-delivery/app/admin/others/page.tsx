...
<div className="relative">
  <label className="flex flex-col items-center justify-center h-80 cursor-pointer border-2 border-dashed border-orange-200 rounded-xl overflow-hidden">
    {(imagePreview || settings.dashboard.image) ? (
      <div className="relative w-full h-full">
        <Image
          src={imagePreview || settings.dashboard.image}
