    ...
    <>
      ...
      {selectedProduct && (
        <>
          ...
          {/* Bottom Sheet */}
          <div
            className={`fixed inset-x-0 bottom-0 z-50 bg-white rounded-t-3xl shadow-2xl transition-transform duration-300 ease-out max-h-[90vh] flex flex-col ${isModalOpen ? 'translate-y-0' : 'translate-y-full'
              }`}
          >
            {/* Drag Handle */}
